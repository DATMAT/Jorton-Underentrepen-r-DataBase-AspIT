        ...
        protected bool DbReturnBool(string sqlQuery, string[] args)
        {
            ...
            {                
                case "usersAddUser":
                    ...
                    cmd.Parameters.Add("@pDepartment", SqlDbType.Int).Value = Convert.ToInt32(args[2]);
                    cmd.Parameters.Add("@pPassword", SqlDbType.NVarChar).Value = args[3];
                    cmd.Parameters.Add("@pJobDescription", SqlDbType.Int).Value = Convert.ToInt32(args[4]);
                    cmd.Parameters.Add("@pUserLevel", SqlDbType.Int).Value = Convert.ToInt32(args[5]);
                    break;
